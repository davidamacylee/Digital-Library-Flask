...
def create_book(current_user_token):
    ...
    year_printed = request.json['year_printed']
    page_length = request.json['page_length']
    user_token = current_user_token.token

    print(f'BIG TESTER: {current_user_token.token}')

    book = Book(title, author, publisher, ISBN, year_printed, page_length, user_token = user_token)
...
def update_book(current_user_token, id):
    ...
    book.year_printed = request.json['year_printed']
